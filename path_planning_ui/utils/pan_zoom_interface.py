...
#-----------------------------------------------------------------------------------------------
    ...
    def set_image(self, img):
        """ set image from function """
        # Decide if this image huge or not
        Image.MAX_IMAGE_PIXELS = 1000000000  # suppress DecompressionBombError for the big image
        with warnings.catch_warnings():  # suppress DecompressionBombWarning
            warnings.simplefilter('ignore')
            self.__image_original = img
            self.__image = self.__image_original
        ...
        self.__pyramid = [self.smaller()] if self.__huge else [self.__image_original]
    ...
    def smaller(self):
        ...
        while i < self.imheight:
            ...
            self.__image.close()
            self.__image = self.__image_original  # reopen / reset image
...
class MainWindow(ttk.Frame):
    ...
    def __init__(self, mainframe, path):
        ...
        canvas.set_image(Image.open(path))
        canvas.grid(row=0, column=0)  # show widget


if __name__ == '__main__':
    app = MainWindow(tk.Tk(), path='MavicCitra.tif')
    app.mainloop()
